...
public final class BankServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.parasuram.models.BalanceCheckRequest,
      com.parasuram.models.Balance> getGetBalanceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getBalance",
      requestType = com.parasuram.models.BalanceCheckRequest.class,
      responseType = com.parasuram.models.Balance.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.parasuram.models.BalanceCheckRequest,
      com.parasuram.models.Balance> getGetBalanceMethod() {
    io.grpc.MethodDescriptor<com.parasuram.models.BalanceCheckRequest, com.parasuram.models.Balance> getGetBalanceMethod;
      ...
      synchronized (BankServiceGrpc.class) {
        if ((getGetBalanceMethod = BankServiceGrpc.getGetBalanceMethod) == null) {
          BankServiceGrpc.getGetBalanceMethod = getGetBalanceMethod =
              io.grpc.MethodDescriptor.<com.parasuram.models.BalanceCheckRequest, com.parasuram.models.Balance>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getBalance"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.parasuram.models.BalanceCheckRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.parasuram.models.Balance.getDefaultInstance()))
  ...
  public static abstract class BankServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getBalance(com.parasuram.models.BalanceCheckRequest request,
        io.grpc.stub.StreamObserver<com.parasuram.models.Balance> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                com.parasuram.models.BalanceCheckRequest,
                com.parasuram.models.Balance>(
  ...
  public static final class BankServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<BankServiceBlockingStub> {
    ...
    /**
     */
    public com.parasuram.models.Balance getBalance(com.parasuram.models.BalanceCheckRequest request) {
  ...
  public static final class BankServiceFutureStub extends io.grpc.stub.AbstractFutureStub<BankServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.parasuram.models.Balance> getBalance(
        com.parasuram.models.BalanceCheckRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_BALANCE:
          serviceImpl.getBalance((com.parasuram.models.BalanceCheckRequest) request,
              (io.grpc.stub.StreamObserver<com.parasuram.models.Balance>) responseObserver);
          break;
        default:
  ...
  private static abstract class BankServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.parasuram.models.BankServiceOuterClass.getDescriptor();
    }
